...
/** remoting xmlhttprequest or activeX object*/
dwr.engine.goodActiveXObject = null;
dwr.engine.goodXMLHttpRequest = null;
...
dwr.engine._origScriptSessionId = "1334FFF9F142E6E6D51F195BEFE63089";
...
dwr.engine._defaultPath = "/dwrTest/dwr";
...
dwr.engine._sendData = function(batch) {
  ...
  // Modify at 20070716 avoid memory leak
  if (batch.rpcType == dwr.engine.XMLHttpRequest) {
    if (window.XMLHttpRequest) {
      if (!dwr.engine.goodXMLHttpRequest) {
      	dwr.engine.goodXMLHttpRequest = new XMLHttpRequest();
      }
      batch.req = dwr.engine.goodXMLHttpRequest;
    }
    // IE5 for the mac claims to support window.ActiveXObject, but throws an error when it's used
    else if (window.ActiveXObject && !(navigator.userAgent.indexOf("Mac") >= 0 && navigator.userAgent.indexOf("MSIE") >= 0)) {
      if (!dwr.engine.goodActiveXObject) {
      	dwr.engine.goodActiveXObject = dwr.engine._newActiveXObject(dwr.engine._XMLHTTP);
      }
      batch.req = dwr.engine.goodActiveXObject;
    }
  }
